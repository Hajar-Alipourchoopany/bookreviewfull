...
import { getBookByISBN, addNewBook, getTopBooks } from '../controller/bookController.js';
import { registerUser, loginUser, logoutUser, getUserReviews, getTopReviewer, addReviewToFavorites, uploadProfileImage } from '../controller/userController.js';
...
router.post('/books', verifyUser, upload.single('book_image'), addNewBook);
